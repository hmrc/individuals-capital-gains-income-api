...
case class Def3_CreateAmendOtherCgtRequestBody(cryptoassets: Option[Seq[Cryptoassets]],
...
object Def3_CreateAmendOtherCgtRequestBody {
  implicit val reads: Reads[Def3_CreateAmendOtherCgtRequestBody] = Json.reads[Def3_CreateAmendOtherCgtRequestBody]

  implicit val writes: OWrites[Def3_CreateAmendOtherCgtRequestBody] = (
