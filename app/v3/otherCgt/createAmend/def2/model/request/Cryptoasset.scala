...
case class Cryptoasset(numberOfDisposals: Int,
...
object Cryptoasset {
  val empty: Cryptoasset = Cryptoasset(0, "", "", "", "", 0.00, 0.00, None, 0.00, None, None, None, None, None)

  implicit val format: OFormat[Cryptoasset] = Json.format[Cryptoasset]
}
