...
import v3.otherCgt.retrieve.RetrieveOtherCgtSchema.*

class RetrieveOtherCgtSchemaSpec extends UnitSpec with MockAppConfig with ScalaCheckDrivenPropertyChecks with TaxYearPropertyCheckSupport {
