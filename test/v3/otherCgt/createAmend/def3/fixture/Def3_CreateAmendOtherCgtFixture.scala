...
package v3.otherCgt.createAmend.def3.fixture

import play.api.libs.json.{JsValue, Json}
import v3.otherCgt.createAmend.def3.model.request.*

object Def3_CreateAmendOtherCgtFixture {
  ...
  val fullRequestBodyModel: Def3_CreateAmendOtherCgtRequestBody = Def3_CreateAmendOtherCgtRequestBody(
