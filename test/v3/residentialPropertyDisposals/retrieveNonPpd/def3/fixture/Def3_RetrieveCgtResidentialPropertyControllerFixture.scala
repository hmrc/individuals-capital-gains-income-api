...
package v3.residentialPropertyDisposals.retrieveNonPpd.def3.fixture
...
object Def3_RetrieveCgtResidentialPropertyControllerFixture {
  ...
  val responseModel: Def3_RetrieveCgtResidentialPropertyResponse =
    Def3_RetrieveCgtResidentialPropertyResponse(
