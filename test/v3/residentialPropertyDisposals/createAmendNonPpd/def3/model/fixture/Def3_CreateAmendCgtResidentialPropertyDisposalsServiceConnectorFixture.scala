...
object Def3_CreateAmendCgtResidentialPropertyDisposalsServiceConnectorFixture {
  ...
  val requestBody: Def3_CreateAmendCgtResidentialPropertyDisposalsRequestBody =
    request.Def3_CreateAmendCgtResidentialPropertyDisposalsRequestBody(
      disposalsModels
    )
