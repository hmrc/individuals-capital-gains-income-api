...
import common.errors.{CustomerRefFormatError, RuleAcquisitionDateAfterDisposalDateError, RuleCompletionDateError, RuleDisposalDateErrorV1, RuleGainLossError, RuleOutsideAmendmentWindow}
