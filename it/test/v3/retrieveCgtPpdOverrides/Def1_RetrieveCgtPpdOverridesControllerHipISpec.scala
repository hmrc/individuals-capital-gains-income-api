...
import v3.residentialPropertyDisposals.retrieveCgtPpdOverrides.def1.fixture.Def1_RetrieveCgtPpdOverridesFixture

class Def1_RetrieveCgtPpdOverridesControllerHipISpec extends IntegrationBaseSpec {
